<template>
  <div
    ...
    class="fixed inset-0 z-[999] grid h-screen w-screen place-content-center place-items-center bg-black bg-opacity-80 opacity-100 backdrop-blur-sm transition-opacity duration-300"
  >
    <div
      class="p-3 relative flex w-full flex-col rounded-xl bg-pink-50 bg-clip-border text-gray-700 shadow-md"
      :class="['max-w-[90vw] max-h-[95vh] min-h-[95vh] h-full w-[95vw]']"
    >
      <div class="container bg-white rounded-md border h-full w-full">
        <div class="h-[7%]">
        ...
        <div class="footer p-3 h-[20%]">
          <div class="flex flex-col justify-center items-center gap-3 h-full">
            <div class="w-full">
              <button
                type="button"
                class="w-full py-2 rounded-md border border-1 border-transparent bg-pink-300 text-white hover:bg-pink-100 hover:text-rose-500 hover:border-pink-200 focus:ring-pink-400 active:bg-pink-600 active:text-white transition duration-150 ease-in-out"
              >
                修改
              </button>
            </div>
            <div class="w-full">
              <button
                type="button"
                class="w-full py-2 rounded-md border border-1 border-red-500 text-red-500 hover:bg-red-100 focus:ring-red-400 active:bg-red-500 active:text-white transition duration-150 ease-in-out"
              >
                刪除
              </button>
            </div>
